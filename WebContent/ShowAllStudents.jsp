...
<tr>
<td id="func">
<a id="fac" href="ProfileAdmin.jsp" >Profile</a>
</td>
<td id="func">
<a id="fac" href="ShowAllStudents.jsp">Show Student Details</a>
</td>
<td id="func">
<a id="fac" href="FaculityDetails.jsp">Show Faculity Details</a>
</td>
<td id="func">
<a id="fac" href="AddCourse.jsp">Add new Course</a>
</td>
<td id="func">
<a id="fac" href="AddFaculity.jsp">Add new Faculity</a>
</td>
<td id="func">
<a id="fac" href="CPAdmin.jsp">Change Password</a>
</td>
<td id="func">
...
try
{
	...
	ResultSet rs = st.executeQuery("select * from users where type='"+s+"'");
%>
