...
<tr>
<td id="func">
<a id="fac" href="ProfileStudent.jsp" >Profile</a>
</td>
<td id="func">
<a id="fac" href="CPStudent.jsp">Change Password</a>
</td>
<td id="func">
<a id="fac" href="Downloader.jsp">Download Files</a>
</td>
<td id="func">
<a id="fac" href="AskQuestion.jsp">Ask a Question</a>
</td>
<td id="func">
<a id="fac" href="SeeAnswers.jsp">See Replies</a>
</td>
<td id="func">
...
try
{
	...
	ResultSet rs = st.executeQuery("select * from filesystem where course='"+cou+"'");
%>
...
<tr>
<td>
<a href="Downloading?fname=<%=rs.getString(1)%>"><%=rs.getString(1)%>
</a>
</td>
<td>
<%=rs.getString(2)%>
